export default function Nav({currentPage, handlePageChange}) {
    ...
    return (
        ...
        <ul>
            ...
            <li><a className="a" href="https://github.com/Olegreg762/">Github</a></li>
            <li><a className={currentPage === 'Resume' ? 'a-active' : "a"} href="#Contact" onClick={() => handlePageChange('Resume')}>Resume</a></li><br></br>
            <li><a className={currentPage === 'About' || currentPage === 'Contact'  || currentPage === 'Resume' ? 'a' : "a-active"} href="#work">My_Work</a></li>:
